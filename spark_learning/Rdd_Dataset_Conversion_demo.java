...
// UDF 
import static commons.Utils.COMMA_DELIMITER;
import commons.Response;


public class Rdd_Dataset_Conversion_demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaRDD<String> lines = sc.textFile("data/2016-stack-overflow-survey-responses.csv");
