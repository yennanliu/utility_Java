 ...
 */
public class Spark_decisiontree_iris {
    ...
    public static void main(String[] args) {
        ...
        SparkSession sparkSession = SparkSession.builder().appName("Spark_decisiontree_iris").config("spark.master", "local").getOrCreate();
        ...
        DecisionTreeClassifier decisionTreeClassifier = new DecisionTreeClassifier().setSeed(seed);
        DecisionTreeClassificationModel model = decisionTreeClassifier.fit(trainingSet);
